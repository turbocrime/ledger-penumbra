...
#define cosmos_crypto_multisig_v1beta1_CompactBitArray_init_default \
    {                                                               \
        0, { {NULL}, NULL }                                         \
    }
#define cosmos_crypto_multisig_v1beta1_MultiSignature_init_zero \
    {                                                           \
        { {NULL}, NULL }                                        \
    }
#define cosmos_crypto_multisig_v1beta1_CompactBitArray_init_zero \
    {                                                            \
        0, { {NULL}, NULL }                                      \
    }
...
#define cosmos_crypto_multisig_v1beta1_MultiSignature_FIELDLIST(X, a) X(a, CALLBACK, REPEATED, BYTES, signatures, 1)
