...
#define _cosmos_tx_signing_v1beta1_SignMode_ARRAYSIZE \
    ((cosmos_tx_signing_v1beta1_SignMode)(cosmos_tx_signing_v1beta1_SignMode_SIGN_MODE_EIP_191 + 1))
...
#define cosmos_tx_signing_v1beta1_SignatureDescriptor_init_default \
    { false, google_protobuf_Any_init_default, false, cosmos_tx_signing_v1beta1_SignatureDescriptor_Data_init_default, 0 }
#define cosmos_tx_signing_v1beta1_SignatureDescriptor_Data_init_default               \
    {                                                                                 \
        0, { cosmos_tx_signing_v1beta1_SignatureDescriptor_Data_Single_init_default } \
    }
#define cosmos_tx_signing_v1beta1_SignatureDescriptor_Data_Single_init_default \
    {                                                                          \
        _cosmos_tx_signing_v1beta1_SignMode_MIN, { {NULL}, NULL }              \
    }
#define cosmos_tx_signing_v1beta1_SignatureDescriptor_Data_Multi_init_default                \
    {                                                                                        \
        false, cosmos_crypto_multisig_v1beta1_CompactBitArray_init_default, { {NULL}, NULL } \
    }
#define cosmos_tx_signing_v1beta1_SignatureDescriptors_init_zero \
    {                                                            \
        { {NULL}, NULL }                                         \
    }
#define cosmos_tx_signing_v1beta1_SignatureDescriptor_init_zero \
    { false, google_protobuf_Any_init_zero, false, cosmos_tx_signing_v1beta1_SignatureDescriptor_Data_init_zero, 0 }
#define cosmos_tx_signing_v1beta1_SignatureDescriptor_Data_init_zero               \
    {                                                                              \
        0, { cosmos_tx_signing_v1beta1_SignatureDescriptor_Data_Single_init_zero } \
    }
#define cosmos_tx_signing_v1beta1_SignatureDescriptor_Data_Single_init_zero \
    {                                                                       \
        _cosmos_tx_signing_v1beta1_SignMode_MIN, { {NULL}, NULL }           \
    }
#define cosmos_tx_signing_v1beta1_SignatureDescriptor_Data_Multi_init_zero                \
    {                                                                                     \
...
#define cosmos_tx_signing_v1beta1_SignatureDescriptors_FIELDLIST(X, a) X(a, CALLBACK, REPEATED, MESSAGE, signatures, 1)
...
#define cosmos_tx_signing_v1beta1_SignatureDescriptor_Data_sum_single_MSGTYPE \
    cosmos_tx_signing_v1beta1_SignatureDescriptor_Data_Single
#define cosmos_tx_signing_v1beta1_SignatureDescriptor_Data_sum_multi_MSGTYPE \
    cosmos_tx_signing_v1beta1_SignatureDescriptor_Data_Multi
...
#define cosmos_tx_signing_v1beta1_SignatureDescriptor_Data_Multi_bitarray_MSGTYPE \
    cosmos_crypto_multisig_v1beta1_CompactBitArray
#define cosmos_tx_signing_v1beta1_SignatureDescriptor_Data_Multi_signatures_MSGTYPE \
    cosmos_tx_signing_v1beta1_SignatureDescriptor_Data
...
#define cosmos_tx_signing_v1beta1_SignatureDescriptor_Data_Multi_fields \
    &cosmos_tx_signing_v1beta1_SignatureDescriptor_Data_Multi_msg
