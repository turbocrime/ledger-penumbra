...
#define cosmos_tx_v1beta1_Tx_init_default                                                                              \
    {                                                                                                                  \
        false, cosmos_tx_v1beta1_TxBody_init_default, false, cosmos_tx_v1beta1_AuthInfo_init_default, { {NULL}, NULL } \
    }
#define cosmos_tx_v1beta1_TxRaw_init_default             \
    {                                                    \
        {{NULL}, NULL}, {{NULL}, NULL}, { {NULL}, NULL } \
    }
#define cosmos_tx_v1beta1_SignDoc_init_default \
    { {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, 0 }
#define cosmos_tx_v1beta1_SignDocDirectAux_init_default                                       \
    {                                                                                         \
        {{NULL}, NULL}, false, google_protobuf_Any_init_default, {{NULL}, NULL}, 0, 0, false, \
            cosmos_tx_v1beta1_Tip_init_default                                                \
    }
#define cosmos_tx_v1beta1_TxBody_init_default                               \
    {                                                                       \
        {{NULL}, NULL}, {{NULL}, NULL}, 0, {{NULL}, NULL}, { {NULL}, NULL } \
    }
#define cosmos_tx_v1beta1_AuthInfo_init_default \
    { {{NULL}, NULL}, false, cosmos_tx_v1beta1_Fee_init_default, false, cosmos_tx_v1beta1_Tip_init_default }
#define cosmos_tx_v1beta1_SignerInfo_init_default \
    { false, google_protobuf_Any_init_default, false, cosmos_tx_v1beta1_ModeInfo_init_default, 0 }
#define cosmos_tx_v1beta1_ModeInfo_init_default               \
    {                                                         \
        0, { cosmos_tx_v1beta1_ModeInfo_Single_init_default } \
    }
#define cosmos_tx_v1beta1_ModeInfo_Single_init_default \
    { _cosmos_tx_signing_v1beta1_SignMode_MIN }
#define cosmos_tx_v1beta1_ModeInfo_Multi_init_default                                        \
    {                                                                                        \
        false, cosmos_crypto_multisig_v1beta1_CompactBitArray_init_default, { {NULL}, NULL } \
    }
#define cosmos_tx_v1beta1_Fee_init_default                  \
    {                                                       \
        {{NULL}, NULL}, 0, {{NULL}, NULL}, { {NULL}, NULL } \
    }
#define cosmos_tx_v1beta1_Tip_init_default \
    {                                      \
        {{NULL}, NULL}, { {NULL}, NULL }   \
    }
#define cosmos_tx_v1beta1_AuxSignerData_init_default                                                                       \
    {                                                                                                                      \
        {{NULL}, NULL}, false, cosmos_tx_v1beta1_SignDocDirectAux_init_default, _cosmos_tx_signing_v1beta1_SignMode_MIN, { \
            {NULL}, NULL                                                                                                   \
        }                                                                                                                  \
    }
#define cosmos_tx_v1beta1_Tx_init_zero                                                                           \
    {                                                                                                            \
        false, cosmos_tx_v1beta1_TxBody_init_zero, false, cosmos_tx_v1beta1_AuthInfo_init_zero, { {NULL}, NULL } \
    }
#define cosmos_tx_v1beta1_TxRaw_init_zero                \
    {                                                    \
        {{NULL}, NULL}, {{NULL}, NULL}, { {NULL}, NULL } \
    }
#define cosmos_tx_v1beta1_SignDoc_init_zero \
    { {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, 0 }
#define cosmos_tx_v1beta1_SignDocDirectAux_init_zero \
    { {{NULL}, NULL}, false, google_protobuf_Any_init_zero, {{NULL}, NULL}, 0, 0, false, cosmos_tx_v1beta1_Tip_init_zero }
#define cosmos_tx_v1beta1_TxBody_init_zero                                  \
    {                                                                       \
        {{NULL}, NULL}, {{NULL}, NULL}, 0, {{NULL}, NULL}, { {NULL}, NULL } \
    }
#define cosmos_tx_v1beta1_AuthInfo_init_zero \
    { {{NULL}, NULL}, false, cosmos_tx_v1beta1_Fee_init_zero, false, cosmos_tx_v1beta1_Tip_init_zero }
#define cosmos_tx_v1beta1_SignerInfo_init_zero \
    { false, google_protobuf_Any_init_zero, false, cosmos_tx_v1beta1_ModeInfo_init_zero, 0 }
#define cosmos_tx_v1beta1_ModeInfo_init_zero               \
    {                                                      \
        0, { cosmos_tx_v1beta1_ModeInfo_Single_init_zero } \
    }
#define cosmos_tx_v1beta1_ModeInfo_Single_init_zero \
    { _cosmos_tx_signing_v1beta1_SignMode_MIN }
#define cosmos_tx_v1beta1_ModeInfo_Multi_init_zero                                        \
    {                                                                                     \
        false, cosmos_crypto_multisig_v1beta1_CompactBitArray_init_zero, { {NULL}, NULL } \
    }
#define cosmos_tx_v1beta1_Fee_init_zero                     \
    {                                                       \
        {{NULL}, NULL}, 0, {{NULL}, NULL}, { {NULL}, NULL } \
    }
#define cosmos_tx_v1beta1_Tip_init_zero  \
    {                                    \
        {{NULL}, NULL}, { {NULL}, NULL } \
    }
#define cosmos_tx_v1beta1_AuxSignerData_init_zero                                                                       \
    {                                                                                                                   \
        {{NULL}, NULL}, false, cosmos_tx_v1beta1_SignDocDirectAux_init_zero, _cosmos_tx_signing_v1beta1_SignMode_MIN, { \
            {NULL}, NULL                                                                                                \
        }                                                                                                               \
    }
...
#define cosmos_tx_v1beta1_ModeInfo_Single_FIELDLIST(X, a) X(a, STATIC, SINGULAR, UENUM, mode, 1)
